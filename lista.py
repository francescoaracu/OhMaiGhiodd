                ...
                if valid_events:
                    ...
                    for event in valid_events:
                        ...
                        for channel in event["channels"]:
                            ...
                            m3u8_content += f"https://ealloradai.onrender.com/proxy/hls/manifest.m3u8?api_password=PobaWave97!&d={channel['stream_url']}&h_user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36&h_referer=https://ilovetoplay.xyz/&h_origin=https://ilovetoplay.xyz\n"
        ...
        with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
            ...
            for category, channels in organized_channels.items():
                ...
                for name, url in channels:
                    ...
                    f.write(f"https://ealloradai.onrender.com/proxy/hls/manifest.m3u8?api_password=PobaWave97!&d={url}\n\n")
